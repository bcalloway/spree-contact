...
desc 'Generate documentation for the contact extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ContactExtension'
...
desc 'Test the contact extension.'
...
namespace :test do
  desc 'Functional test the contact extension.'
  ...
  desc 'Unit test the contact extension.'
